...
import bookGenreRoutes from "./api/book-genres/book-genre.routes";
...
import bookWishlistRoutes from "./api/book-wishlist/book-wishlist.routes";
...
router.use("/book-genres", bookGenreRoutes);
...
router.use("/book-pictures", bookPictureRoutes);
router.use("/book-wishlist", bookWishlistRoutes);
router.use("/book-reviews", bookReviewRoutes);
